...
floodresponsemw <- data_in

# Export Data ------------------------------------------------------------------
usethis::use_data(floodresponsemw, overwrite = TRUE)
fs::dir_create(here::here("inst", "extdata"))
readr::write_csv(floodresponsemw,
                 here::here("inst", "extdata", paste0("floodresponsemw", ".csv")))
openxlsx::write.xlsx(floodresponsemw,
                     here::here("inst", "extdata", paste0("floodresponsemw",
                                                          ".xlsx")))
